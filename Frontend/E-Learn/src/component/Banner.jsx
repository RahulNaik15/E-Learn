...
const Banner = () => {
  return (
      <>
      <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row mt-30 gap-[7vw] items-center'>
            <div className='w-full order-2 md:order-1 md:w-1/2 flex flex-col gap-7 text-center md:text-left'>
                  ...
                  <button className=" px-5 py-3 rounded-lg w-48 text-[white] font-bold bg-[#1974d2] hover:bg-[#0e39a9]">View Courses</button>
            </div>
            </div> 
